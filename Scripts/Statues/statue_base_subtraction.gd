...
@export var item_name : String = "Subtractive"
...
func create_tooltip() -> void:
	statue_tooltip = "
	Statue Base
	Subtraction: Has a base value of " + str(base_statue_value) + ", this gets subtracted from the value of the model placed above this base."
