...
@onready var rigid_body_3d: Leaded_die = $"."
...
@export var tooltip : String = "Warning, do not use this to make Gasoline, Paint, or anything, really."
@export var description : String = "Rolls 1-6. Very heavy, making it very rarely fly outside the box. When it does, it gives a higher multiplier boost."
