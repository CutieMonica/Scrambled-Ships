...
@onready var rigid_body_3d: chaosDie = $"."
...
@export var item_name : String = "Chaos Die"
@export var tooltip : String = "I can do anything!"
@export var description : String = "Rolls 1-12. At the start of every round, it changes all of its values, randomizing all six sides."
...
func _ready() -> void:
	...
	randomize_numbers()
	var random_tooltip : int = GameManager.rng.randi_range(1, 5)
	match random_tooltip:
		1:
			tooltip = "I can do anything!"
		2:
			tooltip = "Chaos, chaos!"
		3: 
		...
		4: 
			tooltip = "Bye-bye!"
		5:
			tooltip = "The true and neo chaos!"
	
func update_ui() -> void:
	dice_logic.update_ui()

func randomize_numbers() -> void:
	side_1_value = GameManager.rng.randi_range(1, 12)
	side_2_value = GameManager.rng.randi_range(1, 12)
	side_3_value = GameManager.rng.randi_range(1, 12)
	side_4_value = GameManager.rng.randi_range(1, 12)
	side_5_value = GameManager.rng.randi_range(1, 12)
	side_6_value = GameManager.rng.randi_range(1, 12)
