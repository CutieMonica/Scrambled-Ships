...
@onready var rigid_body_3d: SkyDie = $"."
...
@export var item_name : String = "Sky Die"
@export var tooltip : String = "Get your head out of the clouds."
@export var description : String = "Rolls 1-6. Very light, making it often fall out of the box when bumped by other dice. It has a slightly lower multiplier boost to compensate."
